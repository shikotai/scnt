...
export const translations = {
  ...
  homeHero: {
    title: "Scientific Center for New Technologies",
    description:
      "«Scientific Center for New Technologies» ЖШС – заманауи ғылыми-зерттеу және инновациялық кластер. Ол озық әзірлемелерді, инновациялық технологияларды және жоғары білікті мамандарды біріктіретің, ғылыми әзірлемелерді нақты секторға тиімді енгізуге бағытталған аккредиттелген ғылыми ұйым.",
    button: "Біз туралы",
  },
  newsCarousel: {
    title: "Жаңалықтар",
    ...
    sections: {
      sophiaUniversity: {
        ...
        paragraph2: {
          ...
          list: {
            ...
            campuses:
              "Халықаралық ынтымақтастық: Университет Georgetown, Yale, LMU Munich және т. б. қоса алғанда, бүкіл әлем бойынша жүздеген жоғары оқу орындарымен серіктестік келісімдерге ие.",
          },
          closing:
      ...
      meetingOkada: {
        ...
        paragraphs: {
          ...
          p2: "Салыстырмалы мәдениет институты (Institute of Comparative Culture, ICC) әлеуметтік ғылымдар, гуманитарлық пәндер, іскерлік зерттеулер және экономика сияқты салалардағы қатысушыларының пәнаралық зерттеулерін дамытуға және қолдауға бағытталған. Институт сонымен қатар өз мүшелеріне София университетінен тыс зерттеушілермен бірлескен жобалар құруға және университеттің ғылыми үстемдік орталығы ретіндегі халықаралық беделін нығайтуға ықпал етеді.",
      ...
      meetingSakaida: {
        ...
        paragraphs: {
          p1: "Sakaida soichi (President, Aqua-Sol Research Center) профессорымен жоғары таза кремний өндірісінде Сулы ерітінділерді тазарту технологияларын қолдану және энергияны сақтау жүйелері үшін көміртегі-кремний материалдарын синтездеудің бірлескен тәсілдері туралы келіссөздер жүргізілді. Сол күні 3-ші Comnext 2025 халықаралық көрмесіне (Tokyo Big Sight) қатысты, онда делегация 6G, IoT, жасанды интеллект және цифрлық трансформация саласындағы соңғы әзірлемелермен танысты, сондай — ақ энергетикалық жүйелерге арналған жабдықтар мен бағдарламалық қамтамасыз етуді әзірлеуші компаниялармен келіссөздер жүргізді.",
          p2: "Сапар аясында Motoyuki Okada (Chairman & Research Institute Director) профессоры және sakaida soichi (President, Aqua-Sol Research Center) профессорымен келіссөздер жүргізілді, онда ғылыми өзара іс-қимыл және бірлескен зерттеу жобаларының бағыттары талқыланды.",
        },
      },
      finalMeeting: {
      ...
      visits: {
        ...
        paragraph:
          "Делегация бірнеше ғылыми орталтар мен серіктес компанияларға барып, ынтымақтастық бағыттары мен технология трансфері мүмкіндіктерін талқылады.",
      },
      results: {
